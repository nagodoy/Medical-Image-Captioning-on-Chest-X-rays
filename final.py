...
st.markdown("<small>by Rajath</small>",unsafe_allow_html=True)
st.markdown("[<small>Github</small>](https://github.com/rajatpai/Medical-Image-Captioning-on-Chest-X-rays)          [<small>Towards Data Science</small>](https://towardsdatascience.com/medical-image-captioning-on-chest-x-rays-a43561a6871d)",
